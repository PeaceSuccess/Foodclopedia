...
export const defaultOptions: ChatComponentOptions = {
  ...
  promptSuggestions: [
    'How is Amala and Ewedu prepared??',
    'What foods are prepared in the southwest region of Nigeria?',
    'Which food is considered the best traditional food in all of Africa?',
  ],
  messages: [],
  strings: {
    promptSuggestionsTitle: 'Ask me about African foods',
    ...
    chatInputPlaceholder: 'Ask me about African Food and Culture...',
    chatInputButtonLabel: 'Send question',
    assistant: 'African Food Expert',
    user: 'You',
